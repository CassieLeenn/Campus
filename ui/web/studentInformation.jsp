...
<form action="personal_s" method="get" id="form">
    <div class="container" style="height: 550px;">
        <div class="login-box">
            ...
            <div class="input">
                <input name="Sno" type="text" placeholder="请输入学号"/>
            </div>
            <div class="input">
                <input name="Sname" type="test" placeholder="请输入姓名"/>
            </div>
            <div class="input">
                <input name="Sdept" type="text" placeholder="请输入专业"/>
            </div>
            <div class="input">
                <input name="Scollege" type="text" placeholder="请输入学院"/>
            </div>
            <div class="input">
                <input name="Sacademy" type="text" placeholder="请输入书院"/>
            </div>
            <button class="btn login-btn" type="submit">
                <span>提交</span>
            </button>
            <div class="change-box login-change">
                <div class="change-btn tobegin" onclick="window.location.href='teacherInformation.jsp';">
                    <span>我是教职工</span>
                </div>
            </div>
        </div>
