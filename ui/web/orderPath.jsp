...
<div class="comments">
    <div class="comment-wrap">
        <div class="comment-block">
            <p class="comment-text">按序路径指的是：确定n个需要按顺序到达的地点，计算行走的最短路径。</p>
        </div>
    </div>
</div>
<div id="box">
    <input id="in" type="search" name="search" class="information" placeholder="请输入景点名称">
...
<div style="float:left;width:500px;height:500px;display: block;position: fixed;_position: absolute;top: 40%;left: 30%;"><p>你输入的地址有：</p><p id="history"></p></div>
